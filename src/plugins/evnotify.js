...
/**
 * @typedef LogStatEntry
 * @type {object}
 * @property {number} id
 * @property {string} akey
 * @property {number} soc_display
 * @property {number} soc_bms
 * @property {number} soh
 * @property {number} charging
 * @property {number} rapid_charge_port
 * @property {number} normal_charge_port
 * @property {number} aux_battery_voltage
 * @property {number} dc_battery_voltage
 * @property {number} dc_battery_current
 * @property {number} dc_battery_power
 * @property {number} latitude
 * @property {number} longitude
 * @property {number} gps_speed
 * @property {number} timestamp
 * @property {null} accuracy
 * @property {null} location_timestamp
 * @property {number} battery_min_temperature
 * @property {number} battery_max_temperature
 * @property {number} battery_inlet_temperature
 * @property {null} slow_charge_port
 * @property {number} cumulative_energy_charged
 * @property {number} cumulative_energy_discharged
 * @property {number} external_temperature
 * @property {null} odo:null}} LogStatEntry
 */
 ...
 * @property {Array.<LogStatEntry>} stats
 */
